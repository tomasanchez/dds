...
`GET /users/:user/events/:event/sugerencias`

> REQUEST JSON

Deberia enviarse mínimamente el usuario del cual obtener eventos, y el evento del cual obtener sugerencias
...
Se debería obtener un _array_, con los datos de Prendas sugeridas.
...
- `200`: Si logra obtener un array de prendas, por mas que este vacío.
- `400`: Si falla la validacion del request
- `401` / `403`: Si no tiene permisos para ver el usuario o evento
- `404`: Si no existe el usuario o evento
- `500`: Para cualquier error del server
- `503`: Servicio no disponible
